  ...
  (
    ...
    return (
      <button
        ...
        type={type}
        className={clsx(
          'flex justify-center items-center border border-gray-300 disabled:opacity-70 disabled:cursor-not-allowed rounded-sm shadow-sm font-medium focus:outline-none',
          variants[variant],
          sizes[size],
          className
        )}
